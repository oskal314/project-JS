...
var images = function images() {
  ...
  workSection.addEventListener('click', function (e) {
    ...
    if (target && target.mathes('div.popup')) {
      imgPopup.style.display = 'none';
    }
  });
};
...
var modals = function modals() {
  ...
  function showModalByTime(selectot, time) {
    setTimeout(function () {
      document.querySelector(selectot).style.display = 'block';
      document.body.classList.add('modal-open');
    }, time);
  }
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // showModalByTime('.popup', 60001);
};
